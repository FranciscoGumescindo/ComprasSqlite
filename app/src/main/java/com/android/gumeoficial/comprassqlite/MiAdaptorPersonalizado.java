package com.android.gumeoficial.comprassqlite;
...
public class MiAdaptorPersonalizado extends BaseAdapter{
    ...
    public MiAdaptorPersonalizado(ArrayList<Compra> lista_productos, Context contexto) {
